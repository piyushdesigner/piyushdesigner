...
export default function Intro() {
  ...
  <p className="text-[9px]">
    Ready to stay update with new trend who can help me reach new trending creativity on market.
      ...
      >
        <Link
         href="mailto:pk88593216@gmail.com"
        ...
        <a
          ...
          href="https://www.linkedin.com/in/piyush-kashyap-aa55b5244"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://www.instagram.com/piyushkashyap1775?igsh=MThncWhlM251bXRvbg%3D%3D&utm_source=qr"
          target="_blank"
        >
          <BiLogoInstagramAlt />
        </a>
